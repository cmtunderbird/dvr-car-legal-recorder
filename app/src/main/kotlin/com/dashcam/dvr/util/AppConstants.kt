...
object AppConstants {
    ...
    const val MIN_FREE_STORAGE_BYTES    = 10L * 1024 * 1024 * 1024  // 10 GB warning threshold
    ...
    const val CALIBRATION_GRAVITY_TOLERANCE_DEG = 5.0f       // re-cal if deviation > 5°
    ...
    // ── Storage health ─────────────────────────────────────────────────────
    /** Minimum write throughput — dual stream 12 Mbps + 20% headroom */
